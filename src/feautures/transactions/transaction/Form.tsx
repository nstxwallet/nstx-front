...
import { FiArrowLeft, FiChevronDown, FiChevronUp, FiCopy } from "react-icons/fi";
...
export const TransactionDetails = ({
  ...
  if (!transaction) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <Button variant="secondary" onClick={() => router.push("/transactions")} className="mt-4">
  ...
  return (
    <Paper className="max-w-lg mx-auto">
      ...
      <Col justify="between" className={`mt-6 ${isExpanded ? "block" : "hidden"}`}>
        <Button variant="transparent" icon={<BiSupport />} onClick={() => router.push("/support")}>
          Support Center
        </Button>
