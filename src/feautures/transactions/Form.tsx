...
export const TransactionsForm = ({ transactions, isLoading, isError }: TransactionsFormProps) => {
  return (
    <Grid>
      ...
      <Paper className="p-8 lg:p-12 bg-zinc-800 rounded-lg shadow-lg space-y-6">
        <Typography variant="h2" className="text-2xl lg:text-3xl font-semibold mb-6">
          Document Contents
        </Typography>
        <ul>
          {[
