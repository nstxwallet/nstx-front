    ...
    <Grid container justify="center" align="center" className="min-h-screen p-8">
      ...
      >
        ...
        <Typography variant="h6">
          Get ready to explore the best trading experience with seamless transactions and top-tier
          security.
        </Typography>
      </Paper>
      <div className="w-full flex justify-center items-center">
        <Paper className="max-w-md">
          ...
          <Link href="/auth/login" className="text-blue-500 hover:text-blue-400 block text-xs">
