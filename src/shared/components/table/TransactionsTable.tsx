...
import { FaCalendarAlt, FaCheckCircle, FaDollarSign, FaInfoCircle } from "react-icons/fa";
    ...
    >
      ...
      <tbody>
        {sortedTransactions.map((transaction) => (
          <tr key={transaction.id} className="border-t border-gray-800 hover:bg-zinc-800">
            <td className="p-4">
              <button
